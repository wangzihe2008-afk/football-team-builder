...
public class Match {
    ...
    public boolean isSecondHalfStarted() {

        return secondHalfStarted;
    }
    ...
    private boolean teamHasCustomPlayer(
            Team team) {
    ...
    public MatchEvent nextEvent() {
        ...
        double homePower =
                homeTeam.getTeamPower();

        double awayPower =
                awayTeam.getTeamPower();

        if (teamHasCustomPlayer(
                homeTeam
        )) {
        ...
        double onTargetChance =
                0.30
                        + shooter
                        .getShooting()
                        * 0.05;

        if (onTargetChance > 0.90) {
    ...
    private void finishMatch() {
        ...
        homeTeam.recordMatch(
                homeScore,
                awayScore
        );

        awayTeam.recordMatch(
                awayScore,
                homeScore
        );
